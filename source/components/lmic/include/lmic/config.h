...
// silently halt execution. Otherwise, LMIC_FAILURE should be defined
...
#if ! defined(DISABLE_LMIC_FAILURE) && ! defined(LMIC_FAILURE)
#include <esp_log.h>
#define LMIC_FAILURE(...) ESP_LOGE("LMIC", ## __VA_ARGS__)
#endif
