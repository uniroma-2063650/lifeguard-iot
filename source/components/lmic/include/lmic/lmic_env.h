...
// and LMIC_TRACE_LEVEL > 0. In each case we might have parameters or
...
// parameter referenced only if LMIC_TRACE_LEVEL > 0
...
// variable referenced only if LMIC_TRACE_LEVEL > 0
